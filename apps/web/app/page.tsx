...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">   {/* Contenedor principal de toda la página */}
        ...
        {error ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {products.map((product) => (          // Recorremos el array de productos
              <div
                key={product.id}
                className="bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 group"
              >
                {/* Imagen del producto */}
                <div className="h-80 bg-gradient-to-br from-[#003087] to-[#00A3E0] flex items-center justify-center relative">
                  <Fish size={96} color="white" className="transition-transform group-hover:scale-110 duration-500" />
                ...
                <div className="p-8">
                  <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">{product.name}</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">{product.description}</p>

                  <div className="mb-6 rounded-2xl bg-gray-50 dark:bg-gray-700 p-4 text-sm">
